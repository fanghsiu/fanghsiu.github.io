...
${a}`};i.scss.additionalData=u}},F=j(import.meta.url),W=$.resolve(F,"../../styles/empty.scss"),m=new A("vuepress-plugin-sass-palette"),d=t=>O.pathExistsSync(t)?t:W,R=(t,s)=>t.writeTemp(`sass-palette/load-${s}.js`,`import "@sass-palette/${s}-inject";
export default {};
...
@import "file:///${d(f)}";
@import "file:///${d(r)}";
`),x=(t,{id:s,defaultPalette:e,generator:n,userPalette:r})=>t.writeTemp(`sass-palette/${s}-palette.scss`,`@import "file:///${d(e)}";
@import "file:///${d(r)}";
@import "file:///${d(n)}";
`),I=(t,{id:s,userStyle:e})=>e?t.writeTemp(`sass-palette/${s}-style.scss`,`@forward "file:///${d(e)}";
`):Promise.resolve(null),v=j(import.meta.url),w=t=>s=>{s.env.isDebug&&m.info(`Options: ${t.toString()}`);const{id:e="hope",config:n=`.vuepress/styles/${e}-config.scss`,defaultConfig:r=$.resolve(v,"../../styles/default/config.scss"),palette:f=`.vuepress/styles/${e}-palette.scss`,defaultPalette:p=$.resolve(v,"../../styles/default/palette.scss"),generator:i=$.resolve(v,"../../styles/empty.scss"),style:l=""}=t,u=s.dir.source(n),o=s.dir.source(f),c=l?s.dir.source(l):null;return{name:"vuepress-plugin-sass-palette",multiple:!0,id:e,alias:{["@sass-palette/helper"]:$.resolve(v,"../../styles/helper.scss"),[`@sass-palette/${e}-config`]:s.dir.temp(`sass-palette/${e}-config.scss`),[`@sass-palette/${e}-inject`]:s.dir.temp(`sass-palette/${e}-inject.scss`),[`@sass-palette/${e}-palette`]:s.dir.temp(`sass-palette/${e}-palette.scss`),...l?{[`@sass-palette/${e}-style`]:s.dir.temp(`sass-palette/${e}-style.scss`)}:{}},extendsBundlerOptions:(a,g)=>{E(a,g,e)},onInitialized:()=>Promise.all([z(s,e),S(s,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}),x(s,{id:e,defaultPalette:p,generator:i,userPalette:o}),I(s,{id:e,userStyle:c})]).then(()=>{s.env.isDebug&&m.info(`Style file for ${e} generated`)}),onWatched:(a,g)=>{const y=b(u,{cwd:a.dir.source(),ignoreInitial:!0}),C=()=>S(a,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});y.on("add",()=>{C()}),y.on("unlink",()=>{C()}),g.push(y);const h=b(o,{cwd:a.dir.source(),ignoreInitial:!0}),k=()=>Promise.all([S(a,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}),x(a,{id:e,defaultPalette:p,generator:i,userPalette:o})]).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});if(h.on("add",()=>{k()}),h.on("unlink",()=>{k()}),g.push(h),c){const P=b(c,{cwd:a.dir.source(),ignoreInitial:!0}),D=()=>I(a,{id:e,userStyle:c}).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});P.on("add",()=>{D()}),P.on("unlink",()=>{D()}),g.push(P)}},clientConfigFile:a=>R(a,e)}},B=(t,s)=>{t.pluginApi.plugins.filter(e=>e.name==="vuepress-plugin-sass-palette").every(e=>e.id!==s.id)&&t.use(w(s))},L=(t,s)=>{const e=t.pluginApi.plugins.filter(n=>n.name==="vuepress-plugin-sass-palette").findIndex(n=>n.id===s);e!==-1&&t.pluginApi.plugins.splice(e,1)};export{w as default,L as removePalettePlugin,w as sassPalettePlugin,B as useSassPalettePlugin};
